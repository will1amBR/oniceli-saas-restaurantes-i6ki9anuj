  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-card p-4 sm:p-5 rounded-2xl border border-border/60 shadow-sm">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight flex items-center gap-2">
            Bar & Doses (KDS)
            <Badge className="bg-indigo-600 text-white text-[10px] font-bold">Drinks & Doses</Badge>
          </h1>
          <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">
            Monitor de coquetéis, sucos e controle de dosimetria em ML.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <Button
            ...
            className="text-xs font-bold gap-1.5 h-10 rounded-xl"
          >
            <GlassWater className="h-4 w-4 text-indigo-600" />
            {showDoseReport ? 'Ocultar Doses (ML)' : 'Relatório Doses (ML)'}
          </Button>
        </div>
      </div>
      ...
      <div className="flex items-center gap-1.5 overflow-x-auto w-full pb-1">
        ...
        >
          <Flame className="h-3.5 w-3.5" /> Preparando ({preparingCount})
        </button>
        <button
      ...
      {/* Main Grid of Bar Order Tickets */}
      {loading ? (
        <OrderCardSkeleton />
      ) : error ? (
        ...
        <Card className="border-dashed py-20 text-center rounded-2xl">
          <CardContent className="space-y-3">
            ...
            <h3 className="font-bold text-lg">Nenhum drink ou bebida na fila!</h3>
              ...
              >
                ...
                <div className="p-4 pt-0 border-t mt-2 pt-3">
                  {isPending && (
                    ...
                    >
                      <Flame className="h-4 w-4" /> Iniciar Coquetelaria
                    </Button>
                  )}
                  ...
                  {isPreparing && (
                    <div className="flex gap-2">
                      ...
                      >
                        <CheckCircle2 className="h-4 w-4" /> Bebida Pronta
                      </Button>
                    </div>
                  )}
